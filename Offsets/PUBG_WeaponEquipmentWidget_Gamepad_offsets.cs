...
namespace Offsets
{
	public class UWeaponEquipmentWidget_Gamepad_C
	{
		...
		///<summary>UWeaponEquipmentSlotWidget_Gamepad_C *</summary>
		...
		///<summary>TArray<UWeaponEquipmentSlotWidget_Gamepad_C * ></summary>
		...
		public const int OnAttachmentFocused = 0x0310;

		///<summary>FScriptMulticastDelegate</summary>
		public const int OnWeaponEquipmentFocused = 0x0320;
