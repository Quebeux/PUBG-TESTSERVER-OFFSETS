...
namespace Offsets
{
	public class UHudMain_C
	{
		...
		///<summary>UMessageHudWidget_C *</summary>
		public const int MessageHudWidget_58 = 0x0370;

		///<summary>UBorder *</summary>
		public const int MiniMapBorder = 0x0378;

		///<summary>UMiniMapWidget_C *</summary>
		public const int MiniMapWidget_147 = 0x0380;

		///<summary>UTextBlock *</summary>
		public const int Name = 0x0388;

		///<summary>UImage *</summary>
		public const int ObserverCrossHair = 0x0390;

		///<summary>UObserverTagManagerWidget_C *</summary>
		public const int ObserverTagManagerWidet = 0x0398;

		///<summary>UCanvasPanel *</summary>
		public const int OnlySpectating = 0x03A0;

		///<summary>UCanvasPanel *</summary>
		public const int OverlayCanvas = 0x03A8;

		///<summary>UReplayZoneAreaMessage_C *</summary>
		public const int ReplayZoneAreaMessage = 0x03B0;

		///<summary>UTextBlock *</summary>
		public const int Spectating = 0x03B8;

		///<summary>UHorizontalBox *</summary>
		public const int SpectatingKeyInfo = 0x03C0;

		///<summary>USpectatingSelectionWidget_C *</summary>
		public const int SpectatingSelectionWidget = 0x03C8;

		///<summary>UHorizontalBox *</summary>
		public const int SpectingPlayerInfo = 0x03D0;

		///<summary>UCanvasPanel *</summary>
		public const int TeamWidgetCanvas = 0x03D8;

		///<summary>UBorder *</summary>
		public const int WeaponSlotHudBorder = 0x03E0;

		///<summary>FScriptMulticastDelegate</summary>
		public const int ButtonClickedDispatcher = 0x03E8;

		///<summary>UHitNotifyWidget_C *</summary>
		public const int HitNotify = 0x03F8;

		///<summary>TArray&lt;UClass * &gt;</summary>
		public const int MiniMapTypes = 0x0400;

		///<summary>FColorBlindColorSet</summary>
		public const int ColorBlindColorSet_SpetatingName = 0x0410;

		///<summary>FTimerHandle</summary>
		public const int ReplayGetTimeHandler = 0x0420;

		///<summary>FWidgetTransform</summary>
		public const int ObserverSpectatingDownPos = 0x0428;

		///<summary>FWidgetTransform</summary>
		public const int ObserverSpectatingUpPos = 0x0444;

		///<summary>float</summary>
		public const int LastOptionToggleTime = 0x0460;
