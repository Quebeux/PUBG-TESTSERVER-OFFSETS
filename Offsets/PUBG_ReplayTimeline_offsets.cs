...
namespace Offsets
{
	public class UReplayTimeline_C
	{
		...
		///<summary>UButton *</summary>
		public const int BtnRec = 0x0258;

		///<summary>UButton *</summary>
		public const int BtnSpeedDown = 0x0260;

		///<summary>UButton *</summary>
		public const int BtnSpeedUp = 0x0268;

		///<summary>UButton *</summary>
		public const int BtnStop = 0x0270;

		///<summary>UCheckBox *</summary>
		public const int CheckBoxGroggys = 0x0278;
