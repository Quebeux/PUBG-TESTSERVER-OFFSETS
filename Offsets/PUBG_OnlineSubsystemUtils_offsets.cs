...
namespace Offsets
{
	...
	public class UPartyBeaconState
	{
		...
		///<summary><![CDATA[TArray<FPartyReservation>]]></summary>
	...
	public class APartyBeaconClient
	{
		...
		///<summary><![CDATA[FPartyReservation]]></summary>
		public const int PendingReservation = 0x0510;

		///<summary><![CDATA[EClientRequestType]]></summary>
		...
		///<summary><![CDATA[unsigned char[0x2D]]]></summary>
	...
	public class AOnlineBeaconHost
	{
		...
		///<summary><![CDATA[TArray<AOnlineBeaconClient * >]]></summary>
	...
	{
		///<summary><![CDATA[UPartyBeaconState *]]></summary>
	...
	public class UOnlinePIESettings
	{
		...
		///<summary><![CDATA[TArray<FPIELoginSettingsInternal>]]></summary>
	...
	{
		///<summary><![CDATA[unsigned char[0x288]]]></summary>
		public const int UnknownData00 = 0x0028;
