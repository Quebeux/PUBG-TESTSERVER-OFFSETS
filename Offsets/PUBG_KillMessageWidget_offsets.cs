...
namespace Offsets
{
	public class UKillMessageWidget_C
	{
		...
		public const int Border_2 = 0x0308;

		///<summary>UHorizontalBox *</summary>
		public const int HorizontalBox_1 = 0x0310;

		///<summary>UImage *</summary>
		public const int Image_1 = 0x0318;

		///<summary>UOverlay *</summary>
		public const int KillCountLayer = 0x0320;

		///<summary>UTextBlock *</summary>
		public const int KillMsgBlock = 0x0328;

		///<summary>UTextBlock *</summary>
		public const int MyKills = 0x0330;

		///<summary>UVerticalBox *</summary>
		public const int VerticalBox_1 = 0x0338;

		///<summary>FDeathMessage</summary>
